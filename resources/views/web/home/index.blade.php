...
<html lang="en">
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-11 d-flex align-items-center">
                        <h1 class="logo"><a href="{{route('web.index')}}">{{Helper::getAppName()?Helper::getAppName()."  ":''}}</a></h1>
                        <!-- Uncomment below if you prefer to use an image logo -->
                        <a href="#" class="logo mr-auto"><img src="{{Helper::getAppLogo() ? Helper::getAppLogo() : ''}}" alt="" class="img-fluid"></a>
                        <nav class="nav-menu d-none d-lg-block">
                            <ul>
                                ...
                                @auth
                                <li class="drop-down"><a href="">Welcome {{ucfirst(Auth::user()->first_name)}}</a>
                                    <ul>
            ...
            <div class="intro-container">
                <div id="introCarousel" class="carousel slide carousel-fade" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active" style="background-image: url({{asset('web/assets/img/intro-carousel/1.jpg')}})">
                        ...
                        <div class="carousel-item" style="background-image: url({{asset('web/assets/img/intro-carousel/2.jpg')}})">
                            <div class="carousel-container">
                                <div class="container">
                        ...
                        <div class="carousel-item" style="background-image: url({{asset('web/assets/img/intro-carousel/3.jpg')}})">
                            <div class="carousel-container">
                                <div class="container">
                        ...
                        <div class="carousel-item" style="background-image: url({{asset('web/assets/img/intro-carousel/4.jpg')}})">
                            <div class="carousel-container">
                                <div class="container">
                        ...
                        <div class="carousel-item" style="background-image: url({{asset('web/assets/img/intro-carousel/5.jpg')}})">
                            <div class="carousel-container">
                                <div class="container">
        ...
        <main id="main">
                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row about-cols">
                        ...
                        <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
                            <div class="about-col">
                                <div class="img">
                                    <img src="{{asset('web/assets/img/about-mission.jpg')}}" alt="" class="img-fluid">
                        ...
                        <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                            <div class="about-col">
                                <div class="img">
                                    <img src="{{asset('web/assets/img/about-plan.jpg')}}" alt="" class="img-fluid">
                        ...
                        <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
                            <div class="about-col">
                                <div class="img">
                                    <img src="{{asset('web/assets/img/about-vision.jpg')}}" alt="" class="img-fluid">
            ...
            <section id="facts">
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="facts-img">
                        <img src="{{asset('web/assets/img/facts-img.png')}}" alt="" class="img-fluid">
                    </div>
            ...
            <section id="clients">
                <div class="container" data-aos="zoom-in">
                    ...
                    <div class="owl-carousel clients-carousel">
                        <img src="{{asset('web/assets/img/clients/client-1.png')}}" alt="">
                        <img src="{{asset('web/assets/img/clients/client-2.png')}}" alt="">
                        <img src="{{asset('web/assets/img/clients/client-3.png')}}" alt="">
                        <img src="{{asset('web/assets/img/clients/client-4.png')}}" alt="">
                        <img src="{{asset('web/assets/img/clients/client-5.png')}}" alt="">
                        <img src="{{asset('web/assets/img/clients/client-6.png')}}" alt="">
                        <img src="{{asset('web/assets/img/clients/client-7.png')}}" alt="">
                        <img src="{{asset('web/assets/img/clients/client-8.png')}}" alt="">
                    </div>
                ...
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="owl-carousel testimonials-carousel">
                        ...
                        <div class="testimonial-item">
                            ...
                            <h4>Ceo &amp; Founder</h4>
                            <p>
                                <img src="{{asset('web/assets/img/quote-sign-left.png')}}" class="quote-sign-left" alt="">
                                Proin iaculis purus consequat sem cure digni ssim donec porttitora entum suscipit rhoncus. Accusantium quam, ultricies eget id, aliquam eget nibh et. Maecen aliquam, risus at semper.
                                <img src="{{asset('web/assets/img/quote-sign-right.png')}}" class="quote-sign-right" alt="">
                            </p>
                        </div>
                        ...
                        <div class="testimonial-item">
                            <img src="{{asset('web/assets/img/testimonial-5.jpg')}}" class="testimonial-img" alt="">
                            <h3>John Larson</h3>
                            <h4>Entrepreneur</h4>
                            <p>
                                <img src="{{asset('web/assets/img/quote-sign-left.png')}}" class="quote-sign-left" alt="">
        ...
        <footer id="footer">
            ...
            ?>
            <div class="container">
                <div class="copyright">{!! $footer !!}<strong>{!!$company!!}</strong>. All Rights Reserved
                </div>
                <div class="credits">
                    <!--
