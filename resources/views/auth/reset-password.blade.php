        ...
        <div class="login-box">
            ...
            <div class="card">
                <div class="card-body login-card-body">
                    <p class="login-box-msg">{{__('admin.reset_password_text')}}</p>
                    ...
                    <form action="{{route('admin.reset-password')}}" method="post">
                        ...
                        <div class="input-group mb-3">
                            <input name="password_confirmation" type="password" class="form-control {{ $errors->has('password') ?'is-invalid':'' }}" placeholder="{{__('admin.password_confirmation')}}">
                            <div class="input-group-append">
                                <div class="input-group-text">
                                    <span class="fas fa-lock"></span>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <button type="submit" class="{{config('custom.btn-primary-form')}} btn-block">{{__('admin.change_password')}}</button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
