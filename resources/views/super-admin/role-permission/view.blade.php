        ...
        <div class="container-fluid">
            <div class="card {{config('custom.card-primary')}}">
                <div class="card-header">
                    ...
                    @can(config('custom_middleware.edit_super_admin_role_permission'))
                    <button type="button" class="{{config('custom.btn-primary')}} update-role-permission update float-right" title="{{__('admin.want_to_update')}}">{{__('admin.want_to_update')}}</button>
                    @endcan
                </div>
                <form method="post" action="{{route('super-admin.role-permission.update',["id"=>$selectedRolId])}}">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select disabled="" name="role_id[]" multiple="" class="form-control select2 {{config('custom.select2-css')}}" data-dropdown-css-class="{{config('custom.select2-css')}}">
                                        @foreach($roles as $record)
                                        <option value="{{$record->id}}" {{ (collect(old('role_id',$selectedRolId))->contains($record->id)) ? 'selected':'' }}>{{ucfirst($record->name)}}</option>
                                        @endforeach
                                    </select>
                                    @error('role_id')
                        ...
                        <input type="hidden" name="role_id" value="{{$selectedRolId}}">
                        <div class="row">
                            <div class="col-md-12">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!--View-->
                                                    <div class="icheck-primary">
                                                        <input {{ (collect(old('permissions',$permission))->contains('View_'.$level1->id)) ? 'checked' : ''  }} type="checkbox" name="permissions[]" class="level1 view_chk level1_{{$level1->id}}" data-level1='i-level1_{{$level1->id}}' value="View_{{$level1->id}}" id="View_{{$level1->id}}">
                                                ...
                                                <td>
                                                    <!--Create-->
                                                    <div class="icheck-primary">
                                                        <input {{ (collect(old('permissions',$permission))->contains('Create_'.$level1->id)) ? 'checked' : ''  }} type="checkbox" name="permissions[]" class="level1 create_chk level1_{{$level1->id}}" data-level1='i-level1_{{$level1->id}}' value="Create_{{$level1->id}}" id="Create_{{$level1->id}}">
                                                ...
                                                <td>
                                                    <!--Edit-->
                                                    <div class="icheck-primary">
                                                        <input {{ (collect(old('permissions',$permission))->contains('Edit_'.$level1->id)) ? 'checked' : ''  }} type="checkbox" name="permissions[]" class="level1 edit_chk level1_{{$level1->id}}" data-level1='i-level1_{{$level1->id}}' value="Edit_{{$level1->id}}" id="Edit_{{$level1->id}}">
                                                ...
                                                <td>
                                                    <!--Delete-->
                                                    <div class="icheck-primary">
                                                        <input {{ (collect(old('permissions',$permission))->contains('Delete_'.$level1->id)) ? 'checked' : ''  }}  type="checkbox" name="permissions[]" class="level1 delete_chk level1_{{$level1->id}}" data-level1='i-level1_{{$level1->id}}' value="Delete_{{$level1->id}}" id="Delete_{{$level1->id}}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!--View-->
                                                    <div class="icheck-primary">
                                                        <input {{ (collect(old('permissions',$permission))->contains('View_'.$level1->id.'_'.$level2->id)) ? 'checked' : ''  }} type="checkbox" name="permissions[]" class="level1 view_chk level1_{{$level1->id}} level2_{{$level2->id}}" data-level2='i-level2_{{$level1->id}}_{{$level2->id}}' value="View_{{$level1->id}}_{{$level2->id}}" id="View_{{$level1->id}}_{{$level2->id}}">
                                                ...
                                                <td>
                                                    <!--Create-->
                                                    <div class="icheck-primary">
                                                        <input {{ (collect(old('permissions',$permission))->contains('Create_'.$level1->id.'_'.$level2->id)) ? 'checked' : ''  }} type="checkbox" name="permissions[]" class="level1 create_chk level1_{{$level1->id}} level2_{{$level2->id}}" data-level2='i-level2_{{$level1->id}}_{{$level2->id}}' value="Create_{{$level1->id}}_{{$level2->id}}" id="Create_{{$level1->id}}_{{$level2->id}}">
                                                ...
                                                <td>
                                                    <!--Edit-->
                                                    <div class="icheck-primary">
                                                        <input {{ (collect(old('permissions',$permission))->contains('Edit_'.$level1->id.'_'.$level2->id)) ? 'checked' : ''  }} type="checkbox" name="permissions[]" class="level1 edit_chk level1_{{$level1->id}} level2_{{$level2->id}}" data-level2='i-level2_{{$level1->id}}_{{$level2->id}}' value="Edit_{{$level1->id}}_{{$level2->id}}" id="Edit_{{$level1->id}}_{{$level2->id}}">
                                                ...
                                                <td>
                                                    <!--Delete-->
                                                    <div class="icheck-primary">
                                                        <input {{ (collect(old('permissions',$permission))->contains('Delete_'.$level1->id.'_'.$level2->id)) ? 'checked' : ''  }} type="checkbox" name="permissions[]" class="level1 delete_chk level1_{{$level1->id}} level2_{{$level2->id}}" data-level2='i-level2_{{$level1->id}}_{{$level2->id}}' value="Delete_{{$level1->id}}_{{$level2->id}}" id="Delete_{{$level1->id}}_{{$level2->id}}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!--View-->
                                                    <div class="icheck-primary">
                                                        <input {{ (collect(old('permissions',$permission))->contains('View_'.$level1->id.'_'.$level2->id.'_'.$level3->id)) ? 'checked' : ''  }}  type="checkbox" name="permissions[]" class="level1 view_chk level1_{{$level1->id}} level2_{{$level2->id}} level3_{{$level3->id}}" data-level3='i-level3_{{$level1->id}}_{{$level2->id}}_{{$level3->id}}' value="View_{{$level1->id}}_{{$level2->id}}_{{$level3->id}}" id="View_{{$level1->id}}_{{$level2->id}}_{{$level3->id}}">
                                                ...
                                                <td>
                                                    <!--Create-->
                                                    <div class="icheck-primary">
                                                        <input {{ (collect(old('permissions',$permission))->contains('Create_'.$level1->id.'_'.$level2->id.'_'.$level3->id)) ? 'checked' : ''  }}  type="checkbox" name="permissions[]" class="level1 create_chk level1_{{$level1->id}} level2_{{$level2->id}} level3_{{$level3->id}}" data-level3='i-level3_{{$level1->id}}_{{$level2->id}}_{{$level3->id}}' value="Create_{{$level1->id}}_{{$level2->id}}_{{$level3->id}}" id="Create_{{$level1->id}}_{{$level2->id}}_{{$level3->id}}">
                                                ...
                                                <td>
                                                    <!--Edit-->
                                                    <div class="icheck-primary">
                                                        <input {{ (collect(old('permissions',$permission))->contains('Edit_'.$level1->id.'_'.$level2->id.'_'.$level3->id)) ? 'checked' : ''  }}  type="checkbox" name="permissions[]" class="level1 edit_chk level1_{{$level1->id}} level2_{{$level2->id}} level3_{{$level3->id}}" data-level3='i-level3_{{$level1->id}}_{{$level2->id}}_{{$level3->id}}' value="Edit_{{$level1->id}}_{{$level2->id}}_{{$level3->id}}" id="Edit_{{$level1->id}}_{{$level2->id}}_{{$level3->id}}">
                                                ...
                                                <td>
                                                    <!--Delete-->
                                                    <div class="icheck-primary">
                                                        <input {{ (collect(old('permissions',$permission))->contains('Delete_'.$level1->id.'_'.$level2->id.'_'.$level3->id)) ? 'checked' : ''  }}  type="checkbox" name="permissions[]" class="level1 delete_chk level1_{{$level1->id}} level2_{{$level2->id}} level3_{{$level3->id}}" data-level3='i-level3_{{$level1->id}}_{{$level2->id}}_{{$level3->id}}' value="Delete_{{$level1->id}}_{{$level2->id}}_{{$level3->id}}" id="Delete_{{$level1->id}}_{{$level2->id}}_{{$level3->id}}">
...
//        }
        ...
        $(".update-role-permission").click(function ()
        {
            ...
            {
                $(this).text("{{__('admin.cancel')}}");
                $(this).attr("title", "{{__('admin.cancel')}}");
            ...
            {
                $(this).text("{{__('admin.want_to_update')}}");
                $(this).attr("title", "{{__('admin.want_to_update')}}");
                $("input[type=checkbox]").attr("disabled", 'disabled');
