    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card {{config('custom.card-primary')}}">
                ...
                <form method="post" action="{{route('admin.language.add')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="name" type="text" class="form-control {{ $errors->has('name') ?'is-invalid':'' }}" placeholder="{{__('admin.language_name_placeholder')}}" value="{{old('name')}}">
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="code" type="text" class="form-control {{ $errors->has('code') ?'is-invalid':'' }}" placeholder="{{__('admin.language_code_placeholder')}}" value="{{old('code')}}">
                                    @error('code')
                                    <div class="text-red">{{ $message }}</div>
                                    @endif
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control field-validate" name="direction">
                                        <option value="rtl" {{ (collect(old('direction'))->contains('rtl')) ? 'selected':'' }}>Right To Left</option>
                                        <option value="ltr" {{ (collect(old('direction'))->contains('ltr')) ? 'selected':'' }}>Left To Right</option>
                                    </select>
                            ...
                            <div class="col-md-1 text-center">
                                ...
                                <div class="text-center">
                                    <img class="logo-table text-center" src="" onerror="this.onerror=null;this.src='{{ Storage::url('default.png')}}'"/>
                                </div>
                            </div>
                        </div>
                    </div>
