    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card <?php echo e(config('custom.card-primary')); ?>">
                ...
                <form method="post" action="<?php echo e(route('admin.general-setting.setting.update-setting')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <?php $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="row">
...
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php if($record->id ==2 && $record->type=='file'): ?>
                                    <!--Logo-->
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" name="setting_<?php echo e($record->id); ?>" class="custom-file-input" onchange="readURL(this, 'default-image-logo')">
                                    ...
                                    <?php elseif($record->id ==3 && $record->type=='file'): ?>
                                    <!--Favicon-->
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" name="setting_<?php echo e($record->id); ?>" class="custom-file-input" onchange="readURL(this, 'default-image-favicon')">
                                            <label class="custom-file-label"><?php echo e($record->setting_key); ?></label>
                                        </div>
                                        <div class="input-group-append">
                                            <!--<span class="input-group-text">Upload</span>-->
                                    ...
                                    <div class="mt-2">
                                        <span class=""><img class="logo-table default-image-favicon" src="<?php echo e(asset(Storage::url($record->setting_val))); ?>" title="<?php echo e($record->setting_key); ?>" onclick="showDetails(this.src)" onerror="this.onerror=null;this.src='<?php echo e(asset(Storage::url('default.png'))); ?>'"/></span>
                                    </div>
                                    <?php elseif($record->type=='file'): ?>
                                    <!--Other Images-->
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" name="setting_<?php echo e($record->id); ?>" class="custom-file-input" onchange="readURL(this, 'default-image-<?php echo e($record->id); ?>')">
                                            <label class="custom-file-label"><?php echo e($record->setting_key); ?></label>
                                        </div>
                                        <div class="input-group-append">
                                            <!--<span class="input-group-text">Upload</span>-->
                                    ...
                                    <div class="mt-2">
                                        <span class=""><img class="logo-table default-image-<?php echo e($record->id); ?>" src="<?php echo e(asset(Storage::url($record->setting_val))); ?>" title="<?php echo e($record->setting_key); ?>" onclick="showDetails(this.src)" onerror="this.onerror=null;this.src='<?php echo e(asset(Storage::url('default.png'))); ?>'"/></span>
                                    </div>
                                    <?php elseif($record->type=='textarea'): ?>
                                    <textarea name="setting_<?php echo e($record->id); ?>" class="form-control textarea <?php echo e($errors->has('setting_'.$record->id) ?'is-invalid':''); ?>" placeholder="<?php echo e($record->setting_key); ?>"><?php echo e(old('setting_val',$record->setting_val)); ?></textarea>
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="<?php echo e($radio); ?>" value="<?php echo e($key); ?>" name="setting_<?php echo e($record->id); ?>" <?php echo e((collect(old('setting_'.$record->id,$record->setting_val,$record->setting_val))->contains($key)) ? 'checked':''); ?>>
                                            <label for="<?php echo e($radio); ?>"><?php echo e(ucfirst($radio)); ?></label>
                                        </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    <?php else: ?>
                                    <input name="setting_<?php echo e($record->id); ?>" type="text" class="form-control <?php echo e($errors->has('setting_'.$record->id) ?'is-invalid':''); ?>" placeholder="<?php echo e($record->setting_key); ?>" value="<?php echo e(old('setting_'.$record->id,$record->setting_val)); ?>">
                                    <?php endif; ?>
                                    <?php $__errorArgs = ['setting_'.$record->id];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php $__env->stopSection(); ?>
<?php $__env->startSection('page_specific_js_important'); ?>
<script>
    $(function(){
...
<?php echo $__env->make('layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/adminpanel/resources/views/admin/general-setting/setting/edit_setting.blade.php ENDPATH**/ ?>