                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select2 select-user <?php echo e($errors->has('user_id') ?'error':''); ?>" name="user_id[]">
                                        ...
                                        <?php if((collect(old('user_id',$user->id))->contains($record->id))): ?>
                                        <option value="<?php echo e($record->id); ?>" <?php echo e((collect(old('user_id',$user->id))->contains($record->id)) ? 'selected':''); ?>><?php echo e($record ? ucfirst($record->name). ' ' .ucfirst($record->last_name) .'('.$record->email.')' : ''); ?></option>
                                        <?php endif; ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="select2 select-role <?php echo e($errors->has('role_id') ?'error':''); ?>" name="role_id[]" multiple="">
                                        ...
                                        <option value="<?php echo e($record->id); ?>" <?php echo e((collect(old('role_id',$role))->contains($record->name)) ? 'selected':''); ?>><?php echo e($record ? ucfirst($record->name) :''); ?></option>
                    ...
                    <div class="card-footer">
                        ...
                        <div class="btn-toolbar float-right">
                            <div class="btn-group mr-2">
                                <a href="<?php echo e(route('super-admin.user-role.index')); ?>" class="<?php echo e(config('custom.btn-danger-form')); ?>" title="<?php echo e(__('admin.cancel')); ?>"><?php echo e(__('admin.cancel')); ?></a>
                            </div>
                            <div class="btn-group">
...
<?php echo $__env->make('layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/adminpanel/resources/views/super-admin/user-role/update_role.blade.php ENDPATH**/ ?>