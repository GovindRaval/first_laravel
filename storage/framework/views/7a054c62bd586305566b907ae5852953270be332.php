        ...
        <div class="login-box">
            ...
            <div class="card">
                <div class="card-body login-card-body">
                    <p class="login-box-msg"><?php echo e(__('admin.forgot_password_text')); ?></p>
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(route('admin.send-reset-link')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <div class="input-group mb-3">
                            <input name="email" type="text" class="form-control <?php echo e($errors->has('email') ?'is-invalid':''); ?>" placeholder="<?php echo e(__('admin.email')); ?>" value="<?php echo e(old('email')); ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <button type="submit" class="<?php echo e(config('custom.btn-primary-form')); ?> btn-block"><?php echo e(__('admin.send_reset_link')); ?></button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>
...
<?php /**PATH /opt/lampp/htdocs/adminpanel/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>