    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card <?php echo e(config('custom.card-primary')); ?>">
                ...
                <form method="post" action="<?php echo e(route('admin.master.country.update',['id' => $singleRecord->id])); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="col-md-12 col-sm-12 p-0">
                                    <div class="form-group">
                                        ...
                                        <input name="country_<?php echo e($language->id); ?>" type="text" class="form-control length-30 <?php echo e($errors->has('country_'.$language->id) ?'is-invalid':''); ?>" placeholder="<?php echo e(__('admin.country')); ?> (<?php echo e(ucfirst($language->name)); ?>)" value="<?php echo e(old('country_'.$language->id,$record?$record->country_name:'')); ?>">
...
<?php echo $__env->make('layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\first_laravel\resources\views/admin/master/country/edit.blade.php ENDPATH**/ ?>