    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card <?php echo e(config('custom.card-primary')); ?>">
                ...
                <form method="post" action="<?php echo e(route('super-admin.role-permission.save')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label><?php echo e(__('admin.select_role')); ?></label><span class="required"></span><small class="<?php echo e(config('custom.text-note-css')); ?>"> <?php echo e(__('admin.select_role_note')); ?> </small>
                                    <select name="role_id[]" multiple="" class="form-control select2 <?php echo e(config('custom.select2-css')); ?>" data-dropdown-css-class="<?php echo e(config('custom.select2-css')); ?>">
                                        ...
                                        <?php if(!$record->permissions()->count()): ?>
                                        <option value="<?php echo e($record->id); ?>" <?php echo e((old('role_id') && collect(old('role_id'))->contains($record->id)) ? 'selected' : ''); ?>><?php echo e(ucfirst($record->name)); ?></option>
                                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!--View-->
                                                    <div class="icheck-primary">
                                                        <input <?php echo e((old('permissions') && collect(old('permissions'))->contains('View_'.$level1->id)) ? 'checked' : ''); ?> type="checkbox" name="permissions[]" class="level1 view_chk level1_<?php echo e($level1->id); ?>" data-level1='i-level1_<?php echo e($level1->id); ?>' value="View_<?php echo e($level1->id); ?>" id="View_<?php echo e($level1->id); ?>">
                                                ...
                                                <td>
                                                    <!--Create-->
                                                    <div class="icheck-primary">
                                                        <input <?php echo e((old('permissions') && collect(old('permissions'))->contains('Create_'.$level1->id)) ? 'checked' : ''); ?> type="checkbox" name="permissions[]" class="level1 create_chk level1_<?php echo e($level1->id); ?>" data-level1='i-level1_<?php echo e($level1->id); ?>' value="Create_<?php echo e($level1->id); ?>" id="Create_<?php echo e($level1->id); ?>">
                                                ...
                                                <td>
                                                    <!--Edit-->
                                                    <div class="icheck-primary">
                                                        <input <?php echo e((old('permissions') && collect(old('permissions'))->contains('Edit_'.$level1->id)) ? 'checked' : ''); ?> type="checkbox" name="permissions[]" class="level1 edit_chk level1_<?php echo e($level1->id); ?>" data-level1='i-level1_<?php echo e($level1->id); ?>' value="Edit_<?php echo e($level1->id); ?>" id="Edit_<?php echo e($level1->id); ?>">
                                                ...
                                                <td>
                                                    <!--Delete-->
                                                    <div class="icheck-primary">
                                                        <input <?php echo e((old('permissions') && collect(old('permissions'))->contains('Delete_'.$level1->id)) ? 'checked' : ''); ?>  type="checkbox" name="permissions[]" class="level1 delete_chk level1_<?php echo e($level1->id); ?>" data-level1='i-level1_<?php echo e($level1->id); ?>' value="Delete_<?php echo e($level1->id); ?>" id="Delete_<?php echo e($level1->id); ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!--View-->
                                                    <div class="icheck-primary">
                                                        <input <?php echo e((old('permissions') && collect(old('permissions'))->contains('View_'.$level1->id.'_'.$level2->id)) ? 'checked' : ''); ?> type="checkbox" name="permissions[]" class="level1 view_chk level1_<?php echo e($level1->id); ?> level2_<?php echo e($level2->id); ?>" data-level2='i-level2_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>' value="View_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>" id="View_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>">
                                                ...
                                                <td>
                                                    <!--Create-->
                                                    <div class="icheck-primary">
                                                        <input <?php echo e((old('permissions') && collect(old('permissions'))->contains('Create_'.$level1->id.'_'.$level2->id)) ? 'checked' : ''); ?> type="checkbox" name="permissions[]" class="level1 create_chk level1_<?php echo e($level1->id); ?> level2_<?php echo e($level2->id); ?>" data-level2='i-level2_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>' value="Create_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>" id="Create_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>">
                                                ...
                                                <td>
                                                    <!--Edit-->
                                                    <div class="icheck-primary">
                                                        <input <?php echo e((old('permissions') && collect(old('permissions'))->contains('Edit_'.$level1->id.'_'.$level2->id)) ? 'checked' : ''); ?> type="checkbox" name="permissions[]" class="level1 edit_chk level1_<?php echo e($level1->id); ?> level2_<?php echo e($level2->id); ?>" data-level2='i-level2_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>' value="Edit_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>" id="Edit_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>">
                                                ...
                                                <td>
                                                    <!--Delete-->
                                                    <div class="icheck-primary">
                                                        <input <?php echo e((old('permissions') && collect(old('permissions'))->contains('Delete_'.$level1->id.'_'.$level2->id)) ? 'checked' : ''); ?> type="checkbox" name="permissions[]" class="level1 delete_chk level1_<?php echo e($level1->id); ?> level2_<?php echo e($level2->id); ?>" data-level2='i-level2_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>' value="Delete_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>" id="Delete_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!--View-->
                                                    <div class="icheck-primary">
                                                        <input <?php echo e((old('permissions') && collect(old('permissions'))->contains('View_'.$level1->id.'_'.$level2->id.'_'.$level3->id)) ? 'checked' : ''); ?>  type="checkbox" name="permissions[]" class="level1 view_chk level1_<?php echo e($level1->id); ?> level2_<?php echo e($level2->id); ?> level3_<?php echo e($level3->id); ?>" data-level3='i-level3_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>_<?php echo e($level3->id); ?>' value="View_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>_<?php echo e($level3->id); ?>" id="View_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>_<?php echo e($level3->id); ?>">
                                                ...
                                                <td>
                                                    <!--Create-->
                                                    <div class="icheck-primary">
                                                        <input <?php echo e((old('permissions') && collect(old('permissions'))->contains('Create_'.$level1->id.'_'.$level2->id.'_'.$level3->id)) ? 'checked' : ''); ?>  type="checkbox" name="permissions[]" class="level1 create_chk level1_<?php echo e($level1->id); ?> level2_<?php echo e($level2->id); ?> level3_<?php echo e($level3->id); ?>" data-level3='i-level3_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>_<?php echo e($level3->id); ?>' value="Create_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>_<?php echo e($level3->id); ?>" id="Create_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>_<?php echo e($level3->id); ?>">
                                                ...
                                                <td>
                                                    <!--Edit-->
                                                    <div class="icheck-primary">
                                                        <input <?php echo e((old('permissions') && collect(old('permissions'))->contains('Edit_'.$level1->id.'_'.$level2->id.'_'.$level3->id)) ? 'checked' : ''); ?>  type="checkbox" name="permissions[]" class="level1 edit_chk level1_<?php echo e($level1->id); ?> level2_<?php echo e($level2->id); ?> level3_<?php echo e($level3->id); ?>" data-level3='i-level3_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>_<?php echo e($level3->id); ?>' value="Edit_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>_<?php echo e($level3->id); ?>" id="Edit_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>_<?php echo e($level3->id); ?>">
                                                ...
                                                <td>
                                                    <!--Delete-->
                                                    <div class="icheck-primary">
                                                        <input <?php echo e((old('permissions') && collect(old('permissions'))->contains('Delete_'.$level1->id.'_'.$level2->id.'_'.$level3->id)) ? 'checked' : ''); ?>  type="checkbox" name="permissions[]" class="level1 delete_chk level1_<?php echo e($level1->id); ?> level2_<?php echo e($level2->id); ?> level3_<?php echo e($level3->id); ?>" data-level3='i-level3_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>_<?php echo e($level3->id); ?>' value="Delete_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>_<?php echo e($level3->id); ?>" id="Delete_<?php echo e($level1->id); ?>_<?php echo e($level2->id); ?>_<?php echo e($level3->id); ?>">
                    ...
                    <div class="card-footer">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check(config('custom_middleware.create_super_admin_role_permission'))): ?>
...
<?php echo $__env->make('layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\first_laravel\resources\views/super-admin/role-permission/index.blade.php ENDPATH**/ ?>