    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo e(__('admin.image_preview')); ?></h4>
...
</script><?php /**PATH C:\xampp\htdocs\first_laravel\resources\views/layout/image_preview.blade.php ENDPATH**/ ?>