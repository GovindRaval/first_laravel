    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card <?php echo e(config('custom.card-primary')); ?>">
                ...
                <form method="post" action="<?php echo e(route('admin.video.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="col-md-12 col-sm-12 p-0">
                                    <div class="form-group">
                                        <label><?php echo e(__('admin.name')); ?> (<?php echo e(ucfirst($language->name)); ?>)<span class="required"></span></label>
                                        <input name="video_<?php echo e($language->id); ?>" type="text" class="form-control length-30 <?php echo e($errors->has('videoname_'.$language->id) ?'is-invalid':''); ?>" placeholder="<?php echo e(__('admin.video-name')); ?> (<?php echo e(ucfirst($language->name)); ?>)" value="<?php echo e(old('city_'.$language->id)); ?>">
...
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label><?php echo e(__('admin.video-url')); ?> <span class="required"></span></label>
                                    <input class="form-control length-30" type="text" name="video_url" placeholder="<?php echo e(__('admin.video-url')); ?>">
...
<?php echo $__env->make('layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\first_laravel\resources\views/admin/video/add.blade.php ENDPATH**/ ?>