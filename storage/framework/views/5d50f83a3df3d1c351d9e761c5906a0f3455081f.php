    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card <?php echo e(config('custom.card-primary')); ?>">
                ...
                <form method="post" action="<?php echo e(route('admin.master.city.add')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <label><?php echo e(__('admin.select_country')); ?><span class="required"></span></label>
...
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input name="city_<?php echo e($language->id); ?>" type="text" class="form-control length-30 <?php echo e($errors->has('city_'.$language->id) ?'is-invalid':''); ?>" placeholder="<?php echo e(__('admin.city')); ?> (<?php echo e(ucfirst($language->name)); ?>)" value="<?php echo e(old('city_'.$language->id)); ?>">
...
<?php echo $__env->make('layout/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\first_laravel\resources\views/admin/master/city/add.blade.php ENDPATH**/ ?>